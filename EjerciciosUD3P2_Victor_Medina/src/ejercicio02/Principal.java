...
public class Principal {
	...
	public static void main(String[] args) {
		...
		/*
		 * debemos crear la clase Habitación, una clase Hotel con una lista de
		 * Habitaciones y una clase principal de prueba para gestionar el hotel Podemos
		 * poner todos los métodos en la clase Hotel. Se podrá hacer lo siguiente:
		 * 
		 * Agregar una habitación a la lista (cuyos atributos serán tipo, precio, qué
		 * servicios extra tiene, String con el nombre de cliente asignado, número de
		 * días contratados, si está limpia, etc.) Ver si está ocupada o no. Calcular
		 * precio final según número de días, servicios extra contratados y consumo del
		 * minibar. Mostrar factura. Aquellos métodos que se quieran añadir. Crear un
		 * main de prueba
		 */
		...
		/*
		 * System.out.println("Añada un porcentaje por tipo de habitacion"); porcentaje
		 * = Leer.datoDouble(); porcentajeHabitacion = precio * porcentaje / cien;
		 */
